...
function SubListTrackOptionsButton(props) {
    // console.log("props in SubListTrackOptionsButton", props)
    const {trackInfo, index, playlistID}:{trackInfo: Track, index: number, playlistID: string} = props
...
export default connect(mapStateToProps, mapDispatchToProps)(SubListTrackOptionsButton)